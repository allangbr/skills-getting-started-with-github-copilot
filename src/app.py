...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for training and weekend matches",
    ...
    "Drama Society": {
        "description": "Rehearse performances and participate in school theater productions",
